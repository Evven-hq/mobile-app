...
export default function ProfileScreen() {
  ...
  return <ProfileEditor key={user.id} user={user} setUser={setUser} onLogout={logout} />;
}
...
function ProfileEditor({
  ...
  onLogout: () => void
    ...
    async function handleSubmit() {
      ...
      setError("");
      try {
        const updatedUser = await updateCurrentUser({name: name.trim(), profile_picture: profilePicture.trim() || null});
        setUser(updatedUser);
    ...
    function handleLogout() {
      Alert.alert("Log out", "Are you sure you want to log out?", [{text: "Cancel", style: "cancel"}, {text: "Log out", style: "destructive", onPress: handleLogout}]);
    }
